...
public class G02_consumerEx {
	/*
	 * 
	 * 자바의 표준 API에서 한개의 추상 메서드를 가진 인터페이스들은 모두 람다식으로 사용 할 수 있다
	 * 람다에 사용되는 함수적 인터페이스를 java.util.function 패키지에 설정해서
	 * 사용하고 있습니다.
	 * 인터페이스 종류 크게 5가지
	 *  - Consumer : 매개변수가 있고, 리턴값이 없는 경우
	 *  - Supplier : 매개변수가 없고, 리턴값이 있는 경우
	 *  - Function : 매개변수도 있고, 리턴값도 있는 경우
	 *  - Operator : 매개변수도 있고, 리턴값도 있는 경우(얀산 결과)
	...
	*/
	...
	public static void main(String[] args) {
		...
		c2.accept("홍길동", 20);
		DoubleConsumer c3 = (score) -> System.out.println("점수는 : "+score+"점");
		c3.accept(99.99);
		ObjIntConsumer<String> c4 = (lecture, i) -> {
			System.out.println("제 "+lecture+"의 점수는 :"+i+"점");
		};
		c4.accept("자바 프로그래밍", 90);
